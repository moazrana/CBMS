...
export class SeederService {
  constructor(
    ...
    private readonly studentPermissionsSeeder: StudentPermissionsSeeder,
    private readonly classPermissionsSeeder: ClassPermissionsSeeder,
  ...
  async seed() {
    ...
    await this.studentPermissionsSeeder.seed();
    await this.classPermissionsSeeder.seed();
