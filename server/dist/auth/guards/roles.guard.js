...
const role_permission_service_1 = require("../../users/services/role-permission.service");
let RolesGuard = class RolesGuard {
    ...
    async canActivate(context) {
        ...
        for (const permission of requiredPermissions) {
            const hasPermission = await this.rolePermissionService.hasPermission(user.role._id, permission.resource, permission.action);
            if (!hasPermission) {
                return false;
            }
        }
